...
\item[\texttt{Supplier}, \texttt{Retailer}, \texttt{Wholesaler}]<3> margins and purchase or delivery efficiencies
\item[\texttt{Middleman}]<4> margin, transaction efficiency
