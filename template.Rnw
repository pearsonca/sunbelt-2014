...
\begin{description}
\item<2->[Network Problems] what goes in (a simulation) is what comes out
\item<3->[A Meth Bust ``Network''] circa 70s Australia
\item<4->[Simulating Production] Breaking Bad?
\item<5->[Next Steps] Observation Model, Intervention Outcomes, Competition, Adaptation
